...
for product in products:
  ...
  price = int(price) + random.randint(1000,8000)
  ...
  query = """ CREATE TABLE IF NOT EXISTS DNS(id INTEGER, price INT, name TEXT, category TEXT, brand TEXT, image TEXT) """
  cursor.execute(query)
  # добавляем строку в таблицу
  query1 = """INSERT INTO DNS(price, name, category, brand, image) VALUES (%s, %s, %s, %s, %s)"""
